...
if ($_POST['check']=='ok') {  
	...
	if(($valid == true)){
			...
			$nome =   $_POST['nome'];
			$email =   $_POST['email'];
			$conferma_presenza = $_POST['conferma_presenza'];
			...
			if( ($nome == true) and ($email == true) and ($conferma_presenza == true) and ( ($numero_persone == true) or ($numero_persone == '0') ) and ($messaggio == true) ){


				//INVIO MAIL ALL'AMMINISTRATORE DEL SITO
				$to         = $tua_email;
				$sbj        = "Luca e Nicoletta - Conferma presenza";
				$msg        = "
				<html>
				<head>
				<style type='text/css'>
				...
				<table width='600' border='0' cellspacing='0' cellpadding='5'>
				  ...
				  <tr>
					<td width='121' align='right' valign='baseline'><strong>Conferma presenza:</strong></td>
					<td width='459'>$conferma_presenza</td>
				  </tr>
				  <tr>
				...
				if( mail($to,$sbj,$msg,$headers)){
					...
					<script>
						...
						window.location.href="<?php echo $base ?>/rsvp.php"
					</script>
					<?php
				}
				else{
				...
				<body>
				  ...
				  <p>Abbiamo ricevuto la tua mail!</p>  
